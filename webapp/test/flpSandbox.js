		...
		services: {
						...
						"groups": [{
							"tiles": [{
								...
								"properties": {
									...
									"targetURL": "#atclouddnafullscreennav-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"atclouddnafullscreennav-display": {
								"semanticObject": "atclouddnafullscreennav",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=at.clouddna.fullscreennav",
									"url": sap.ui.require.toUrl("at/clouddna/fullscreennav")
								}
							}
						}
					}
